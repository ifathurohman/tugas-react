...
const productDetail = () => {
  ...
  useEffect(() => {
    dispatch(getProductDetails(name.q));
  }, [dispatch]);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex justify-between">
                ...
                <div className="flex">
                  <button className="flex ml-auto text-white bg-indigo-500 border-0 mr-2 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                    Buy It Now
                  </button>
                  <button
                    className="flex ml-2 text-black border border-indigo-500 py-2 px-6 focus:outline-none hover:bg-indigo-600 hover:text-white rounded"
